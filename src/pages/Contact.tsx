...
// ─── Lookup de planes (colores + nombres) ────────────────────────────────────
...
export default function Contact() {
  ...
  // Motivo de contratar plan para el select
  const motivoContrato = planInfo ? `Contratar — ${planInfo.nombre}` : "";

  // Si viene un plan, pre-rellena el motivo
  ...
  // Si cambia el plan en la URL, actualiza el motivo
  useEffect(() => {
  ...
  // Opciones del select: si viene un plan, agrega su opción al inicio
  ...
  return (
    ...
    >
      ...
      <div className="fixed pointer-events-none" style={{ top: -200, left: "50%", transform: "translateX(-50%)", width: 700, height: 500, zIndex: 1, background: planInfo ? `radial-gradient(ellipse, ${planInfo.color}15 0%, transparent 70%)` : "radial-gradient(ellipse, rgba(109,40,217,0.18) 0%, transparent 70%)" }} />
      ...
      <section className="relative px-6 md:px-12 py-16 md:py-20 mx-auto" style={{ zIndex: 5, maxWidth: 1100 }}>
        ...
        {planInfo && (
          <div
            ...
            style={{
              marginBottom: 32,
              background: `linear-gradient(135deg, ${planInfo.color}10, ${planInfo.colorOscuro}08)`,
          ...
          >
            ...
            <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: 3, background: `linear-gradient(180deg, ${planInfo.color}, ${planInfo.colorOscuro})`, borderRadius: "16px 0 0 16px" }} />
            ...
            <div style={{ flex: 1 }}>
              <p
                style={{
                  ...
                  color: planInfo.color, marginBottom: 4,
                }}
              >
                Plan seleccionado
              </p>
              <p
                style={{
                  ...
                  fontWeight: 700, color: "#f1f0ff",
                  letterSpacing: -0.3,
                }}
              >
                Estás a punto de contratar el{" "}
                <span style={{ color: planInfo.color }}>
                  Plan {planInfo.nombre}
                </span>
              </p>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "rgba(241,240,255,0.45)", marginTop: 3, lineHeight: 1.5 }}>
                Completa el formulario y nos pondremos en contacto para coordinar los detalles.
              </p>
            </div>
        ...
        <div className="grid gap-12" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))" }}>
          ...
          {/* Formulario */}
          <div className="rounded-2xl p-8" style={{ background: "#0e0e1a", border: `1px solid ${planInfo ? planInfo.color + "20" : "rgba(255,255,255,0.06)"}` }}>
            {sent ? (
              ...
              <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <Field label="Nombre completo" error={errors.from_name}>
                  <input
                    type="text"
                    className={`contact-input${errors.from_name ? " err" : ""}`}
                    placeholder="Nombre"
                ...
                <Field label="Correo electrónico" error={errors.from_email}>
                  <input
                    type="email"
                    className={`contact-input${errors.from_email ? " err" : ""}`}
                ...
                <Field label="Teléfono" error={errors.phone}>
                  <input
                    type="tel"
                    className={`contact-input${errors.phone ? " err" : ""}`}
                ...
                >
                  {loading
                    ? "Enviando..."
                    : planInfo
                      ? `Solicitar Plan ${planInfo.nombre}`
                      : "Enviar mensaje"}
                </button>
              </form>
            )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24, justifyContent: "center" }}>
            {[
              {
                icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" strokeLinecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
                title: "Correo",
                value: "contacto@kodafix.cl",
              },
              {
                icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
                title: "Respuesta",
